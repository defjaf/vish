...
/* it takes (Omega Omega_vac h n Omega_bh2 Radius z_i delta_z) on */
/* the command line and produces the analog of the curve in GH's */
/* fig. 1.  i.e., the Cl's for randomly placed spheres of Radius at */
/* redshift z_i with width delta_z.  the relevant output is in */
/* patchy.out.  there are four columns for their approximation (but */
/* doing the w integral), the approximation in their paper, our */
/* result, and our result obtained without doing the w integral. */

/* more details on what this means are in the latex file which */
/* follows. */
