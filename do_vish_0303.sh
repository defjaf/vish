...
modlist="WMAP_20_6 WMAP6 WMAP20"
  for model in  ${modlist}; do
    ...
    case $model in 
     WMAP6) Omega=0.3; Omega_vac=0.7; h=0.72; n_s=0.93; OmegaBh2=0.020;
	    z_m=6; x_0=1.0;;
     WMAP20) Omega=0.3; Omega_vac=0.7; h=0.72; n_s=0.93; OmegaBh2=0.020; 
	     z_m=20; x_0=1.0;;
     WMAP_20_6) Omega=0.3; Omega_vac=0.7; h=0.72; n_s=0.93; OmegaBh2=0.020; 
		do_xe_array=1; xe_file="./xe_20_6.dat";
		z_m=20; x_0=1.0; tau_r=0.0;;
